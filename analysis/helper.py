...
def summarise (path, dropFields=[], fieldOperations=DEFAULT_FIELD_OPERATIONS):
    ...
    return convertDataIntoPandasDataframe(postProcessingObjectMean), convertDataIntoPandasDataframe(postProcessingObjectMedian), convertDataIntoPandasDataframe(postProcessingStandardDeviationObject)
...
def convertDataIntoPandasDataframe (object):
    outputObject = {}
...
def condenseRobustnessTables (pathPrefix, range_=(1, 31), useMetric='mean', dropFields=[]):
